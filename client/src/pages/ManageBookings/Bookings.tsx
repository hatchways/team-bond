      ...
      <Card elevation={2} sx={{ width: cardWidth, height: cardHeight, marginBottom: 1, paddingTop: 1 }}>
        <CardHeader
          ...
          titleTypographyProps={{
            variant: 'subtitle2',
            sx: { paddingBottom: headerPaddingB, fontSize: headerFontSize, fontWeight: 600, fontFamily: 'Arial' },
          }}
          title={title}
          subheaderTypographyProps={{
            variant: 'h6',
            sx: { fontSize: subHeaderFontSize, fontWeight: 600, color: 'black' },
          }}
          subheader={bookings.date}
        />
        <CardContent sx={{ paddingBottom: '0px' }}>
          <Avatar alt="" sx={{ float: 'left' }} />
          <Typography sx={{ float: 'right' }}>{status}</Typography>
          <Typography
            variant="h6"
            color="text.primary"
